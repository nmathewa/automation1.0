...
CONTROLLABLE: frozenset[str] = frozenset({
    ...
    "output.side_mode",
    "output.side_animation",
    "output.side_brightness",
    "output.stereo_threshold",
    "output.stereo_emphasis",
    "output.track_gap",
    "output.uplift_warmup",
    "output.uplift_surge_db",
    "output.uplift_floor_recovery",
    "output.unison_threshold",
    "output.unison_full_trigger",
    "output.unison_response",
    "output.unison_beats",
    "output.accent_animation",
    "output.accent_strength",
    "output.accent_alternate",
    "output.accent_threshold",
    "output.accent_beats",
    "output.accent_stem_change",
    "output.accent_decay",
    "output.accent_length_beats",
    "output.accent_attack",
    "output.wash_span",
