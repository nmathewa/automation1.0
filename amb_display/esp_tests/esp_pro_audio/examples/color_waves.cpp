...
// NOTE: On NodeMCU/Wemos D1 Mini:
// GPIO 4 usually equals Pin labeled "D2" on the board.
#define DATA_PIN    D4  
#define LED_TYPE    WS2812B
#define COLOR_ORDER GRB
#define NUM_LEDS    107      // Change this to reflect the number of LEDs you have
...
void colorwaves( CRGB* ledarray, uint16_t numleds, CRGBPalette16& palette) 
{
  ...
  // uint8_t sat8 = beatsin88( 87, 220, 250); // Unused var commented out
